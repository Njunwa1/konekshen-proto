...
func (x *RecommendUsersResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *RecommendUsersResponse) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *RecommendUsersResponse) GetDob() string {
	if x != nil {
		return x.Dob
	}
	return ""
...
func (x *RecommendUsersResponse) GetLocation() *Location {
	if x != nil {
		return x.Location
	}
	return nil
...
func (x *RecommendUsersResponse) GetProfileImages() []string {
	if x != nil {
		return x.ProfileImages
	}
	return nil
...
func (x *RecommendUsersResponse) GetLookingFor() string {
	if x != nil {
		return x.LookingFor
	}
	return ""
...
func (x *RecommendUsersResponse) GetTelegramId() int32 {
	if x != nil {
		return x.TelegramId
	}
	return 0
...
func (x *RecommendUsersResponse) GetInterests() []string {
	if x != nil {
		return x.Interests
	}
	return nil
...
func (x *RecommendUsersResponse) GetBio() string {
	if x != nil {
		return x.Bio
	}
	return ""
...
func (x *RecommendUsersResponse) GetSex() string {
	if x != nil {
		return x.Sex
	}
	return ""
...
var file_users_user_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x9d, 0x02, 0x0a, 0x16, 0x52, 0x65, 0x63,
	...
	0x61, 0x6d, 0x49, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x74, 0x65, 0x6c, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x73, 0x65, 0x78, 0x32, 0xec, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65,
	0x72, 0x12, 0x67, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	0x64, 0x65, 0x64, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x16, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x6d,
	0x6d, 0x65, 0x6e, 0x64, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x17, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x55, 0x73, 0x65, 0x72,
	...
	0x2f, 0x72, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x12, 0x52, 0x0a, 0x08, 0x52, 0x65,
	...
	0x75, 0x73, 0x65, 0x72, 0x73, 0x2f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x46,
	...
	0x2a, 0x22, 0x13, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x73,
	0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x5f, 0x0a, 0x0b, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79,
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x13, 0x2e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x56, 0x65, 0x72,
	...
	0x79, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_users_user_proto_goTypes = []interface{}{
	...
	(*RecommendUsersResponse)(nil), // 8: RecommendUsersResponse
}
var file_users_user_proto_depIdxs = []int32{
	...
	0, // 2: RecommendUsersResponse.location:type_name -> Location
	7, // 3: User.GetRecommendedUsers:input_type -> RecommendUsersRequest
	1, // 4: User.Register:input_type -> RegisterRequest
	3, // 5: User.Login:input_type -> LoginRequest
	5, // 6: User.VerifyToken:input_type -> VerifyTokenRequest
	8, // 7: User.GetRecommendedUsers:output_type -> RecommendUsersResponse
	2, // 8: User.Register:output_type -> RegisterResponse
	4, // 9: User.Login:output_type -> LoginResponse
	6, // 10: User.VerifyToken:output_type -> VerifyTokenResponse
